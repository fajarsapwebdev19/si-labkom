				...
				<div class="sidebar-user">
					<div class="d-flex justify-content-center">
						<div class="flex-shrink-0">
							<img src="../assets/admin/img/avatars/user.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall">
						</div>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						...
						<ul id="pages" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
							<li class="sidebar-item"><a class="sidebar-link" href="?page=rkp_kom">Komponen Komputer</a></li>
                    ...
                    <li class="sidebar-item">
						...
						<ul id="verif" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            ...
                            <li class="sidebar-item"><a class="sidebar-link" href="?page=ver_skm">Selesai Menggunakan PC</a></li>
                            <li class="sidebar-item"><a class="sidebar-link" href="?page=ver_alt">Peminjaman Alat Praktik</a></li>
                            <li class="sidebar-item"><a class="sidebar-link" href="?page=ver_bck">Pengembalian Alat Praktik</a></li>
						</ul>
					</li>
                    ...
                    <li class="sidebar-item">
						...
						<ul id="note" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            ...
                            <li class="sidebar-item"><a class="sidebar-link" href="?page=note_ppr">Peminjaman Alat Praktik</a></li>
						</ul>
					</li>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="?page=app_reg">
							<i class="align-middle fas fa-user-check"></i> <span class="align-middle">Approv Registrasi Akun</span>
						</a>
					</li>

                    <li class="sidebar-item">
						<a class="sidebar-link" href="?page=lap_buy">
							<i class="align-middle fas fa-swatchbook"></i> <span class="align-middle">Laporan Pembelian Alat</span>
						</a>
					</li>
				</ul>
			</div>
