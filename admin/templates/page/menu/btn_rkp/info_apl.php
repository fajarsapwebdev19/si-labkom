  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Detail Alat Praktik Lab</h5>
      ...
      <div class="modal-body">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 mb-3">
                    <b>Foto Alat</b>
                    <p class="mt-4"><img class="mb-3" src="../assets/img/alat_praktik/<?= $data['foto_alat'] ?>" width="250"></p>
                </div>
                <div class="col-sm-6 mb-3">
                    <b>Pengguna Alat</b>
                    <p>
