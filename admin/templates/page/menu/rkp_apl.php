        ...
        <div class="col-12 col-sm-12 col-md-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h5 class="card-title mb-0" style="color: black;">Alat Praktik</h5>
                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="../proses/save_alat.php" method="post" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <tbody>
                                ...
                                <?php foreach($q as $data) : ?>
                                    <tr>
                                        ...
                                        <td><img src="../assets/img/alat_praktik/<?= $data['foto_alat'] ?>" width="50"></td>
                                        ...
                                        <?php
                                            include 'btn_rkp/info_apl.php';
                                            include 'btn_rkp/update_apl.php';
                                            include 'btn_rkp/delete_apl.php';
                                        ?>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
