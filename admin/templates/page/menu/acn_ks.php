        ...
        <div class="col-12 col-sm-12 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0" style="color: black;">Akun Kepala Sekolah</h5>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover nowrap" id="example">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                $adm = mysqli_query($koneksi, "SELECT * FROM user WHERE level='Kepsek' AND sts_akun='Aktif' AND registrasi_status='Terima' UNION SELECT * FROM user WHERE level='Kepsek' AND sts_akun='Tidak Aktif' AND registrasi_status='Terima'");
                            ?>
                                ...
                                <tr>
                                    ...
                                    <?php include 'btn/block_ks.php';?>
                                    <?php include 'btn/delete_ks.php'; ?>
                                    <?php include 'btn/active_ks.php'; ?>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
