    ...
    <div class="sidebar-content js-simplebar">
        ...
        <div class="sidebar-user">
            <div class="d-flex justify-content-center">
                ...
                <div class="flex-grow-1 ps-2">
                    ...
                    <div class="sidebar-user-subtitle"><?= $kepsek['level'] ?></div>
                </div>
            </div>
        </div>
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item active">
                ...
                <ul id="note" class="sidebar-dropdown list-unstyled collapse show" data-bs-parent="#sidebar">
                    <li class="sidebar-item"><a class="sidebar-link" href="?page=note_pkm">Menggunakan PC</a></li>
                    <li class="sidebar-item active"><a class="sidebar-link" href="?page=note_ppr">Peminjaman Alat Praktik</a>
                    </li>
                </ul>
            </li>
