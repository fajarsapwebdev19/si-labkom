<?php
    ...
    if(isset($_POST['tambah']))
    {
        ...
        $jumlah_terpakai = mysqli_real_escape_string($konekes, htmlspecialchars($_POST['jumlah_terpakai']));
        $rand = rand();
        ...
        $dir = '../assets/img/komponen/'.$foto_alat;
        ...
        if(!in_array($x, $ex))
        {
            ...
            if($size > 3000000)
            {
                ...
                $add = mysqli_query($koneksi, "INSERT INTO komponen_komputer VALUES(NULL, '$nama_alat','$jenis_alat','$foto_alat','$jumlah','$jumlah_terpakai')");
