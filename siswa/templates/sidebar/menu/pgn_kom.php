        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item active">
                ...
                <ul id="pages" class="sidebar-dropdown list-unstyled collapse show" data-bs-parent="#sidebar">
                    <li class="sidebar-item active"><a class="sidebar-link" href="?page=pgn_kom">Komputer</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="?page=pgn_apl">Alat Praktik Lab</a></li>
                </ul>
            </li>
